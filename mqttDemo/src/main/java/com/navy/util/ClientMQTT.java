...
public class ClientMQTT {
	//https://blog.csdn.net/qq_37258787/article/details/79177583
	//https://blog.csdn.net/r1037/article/details/78222114?locationNum=10&fps=1
	public static final String HOST = "tcp://132.232.176.224:1883";
	public static final String TOPIC1 = "pos_message_all";
	private static final String clientid = "client11";
	private MqttClient client;
	private MqttConnectOptions options;
	private String userName = "haishui"; // 非必须
	private String passWord = "haiShui2018"; // 非必须
